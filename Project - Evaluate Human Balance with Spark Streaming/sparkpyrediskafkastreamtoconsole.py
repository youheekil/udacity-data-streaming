...
# emailAndBirthYearStreamingDF = emailAndBirthDayStreamingDF.select('birthDay', split(emailAndBirthDayStreamingDF.birthDay,"-").getItem(0).alias("birthYear"))
...
# /home/workspace/submit-redis-kafkastreaming.sh
